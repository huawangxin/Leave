...
<body>
    ...
    <sf:form id="form1" method="post" modelAttribute="basicUser">
    <ul class="forminfo">
    <li><label>用户名</label>
    <label class="dfinput" style="width:345px;height:30px">${basicUser.name }</label><br/><br/>
    </li>
    <li><label>部    门</label>
    <label class="dfinput" style="width:345px;height:30px">${basicUser.department }</label><br/><br/>
    </li>
    <li><label>职    位</label>
    <label class="dfinput" style="width:345px;height:30px">${basicUser.position }</label><br/><br/>
    </li>
    <li><label>可调休时间</label>
    <label class="dfinput" style="width:345px;height:30px">${basicUser.remainTime } 天</label><br/><br/>
    </li>
